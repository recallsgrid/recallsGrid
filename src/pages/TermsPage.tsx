...
<li><p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to Recallsgrid, 71 Stevenson Street, San Francisco, CA 94102, USA.</p></li>
...
<li><p><strong>Website</strong> refers to Recallsgrid, accessible from <a href="https://recallsgrid.com/" rel="external nofollow noopener" target="_blank">https://recallsgrid.com/</a></p></li>
...
<ul>
<li><p>By email: support@recallsgrid.com</p></li>
<li><p>By visiting this page on our website: <a href="https://recallsgrid.com/" rel="external nofollow noopener" target="_blank">https://recallsgrid.com/</a></p></li>
<li><p>By phone: +1 (415) 555-2113</p></li>
</ul>
`;

export function TermsPage() {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(37,99,235,0.12),_transparent_32%),linear-gradient(135deg,_#f8fbff_0%,_#eef4ff_100%)] px-4 py-16 text-slate-900 sm:px-6 lg:px-8">
      <div className="mx-auto flex max-w-5xl flex-col gap-8 rounded-[2rem] border border-slate-200/70 bg-white/90 p-8 shadow-2xl shadow-slate-900/10 backdrop-blur sm:p-10 lg:p-14">
        ...
        <div className="space-y-2">
          <h1 className="text-3xl font-semibold tracking-tight text-slate-950 sm:text-4xl">Terms and Conditions</h1>
          <p className="text-sm font-medium text-slate-500">Last updated: July 17, 2026</p>
        </div>
